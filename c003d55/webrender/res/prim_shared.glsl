 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
        ...
        #endif
        #define SAMPLER_HIGHP highp
    #endif
#else
    #define SAMPLER_HIGHP
#endif
...
uniform SAMPLER_HIGHP sampler2D sLayers;
uniform SAMPLER_HIGHP sampler2D sRenderTasks;
uniform SAMPLER_HIGHP sampler2D sPrimGeometry;

uniform SAMPLER_HIGHP sampler2D sData16;
uniform SAMPLER_HIGHP sampler2D sData32;
uniform SAMPLER_HIGHP sampler2D sData64;
uniform SAMPLER_HIGHP sampler2D sData128;
uniform SAMPLER_HIGHP sampler2D sResourceRects;
